...
import { MdDeleteForever, MdKeyboard, MdRotateRight} from 'react-icons/md';
import { HiOutlinePlusCircle} from 'react-icons/hi';
import { RiArrowDownSLine, RiInformationLine} from 'react-icons/ri';
import { BiPencil, BiDotsHorizontalRounded, BiFullscreen} from 'react-icons/bi';
import { FiUpload, FiCopy} from 'react-icons/fi';
import { AiOutlineArrowLeft, AiOutlineArrowRight} from 'react-icons/ai';
import { BsFileEarmarkText} from 'react-icons/bs';
import { GiMatchHead, GiFallingBlob} from 'react-icons/gi';
...
const StudySet = () => {
    ...
    const deleteStudySet = () => {
        ...
        if (currentUser.isAnonymous === true ? navigate('/' + currentUser.uid + '/view/sets')
            :
            navigate('/' + currentUser.displayName.replace(/ /g, '') + '/view/sets')
        );
    }
